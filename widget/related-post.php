<style>
	...
	.widget_related_posts .related-title{box-shadow:0 3px 6px rgba(0,0,0,.1);background-color:<?php echo get_option('related_title_background','#03a9f4');?>;font-size:2rem;color:<?php echo get_option('related_title_color','#fff');?>;text-align:center;vertical-align:middle;}
