		...
		<section id="primary" class="content-area">
			...
			<?php if(have_posts()):?>
				...
				if(is_page()||is_single()):
					get_template_part('content',get_post_format());echo'<div id="movetop">∧</div><script>document.getElementById("movetop").click(function(){jQuery("body,html").animate({scrollTop:0},500);});</script>';
				else:get_template_part('content-card',get_post_format());endif;endwhile;
