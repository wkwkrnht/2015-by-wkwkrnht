...
function twentyfifteen_get_color_scheme_css( $colors ) {
	...
	blockquote,.logged-in-as a:hover,.comment-author a:hover{border-color:{$colors['textcolor']};border-color:{$colors['secondary_textcolor']};}
	hr,.dropdown-toggle:hover,.dropdown-toggle:focus{background-color:{$colors['textcolor']};background-color:{$colors['border_color']};}
	pre,
	abbr[title],
	table,
	th,
	...
	a:focus,button:focus,input:focus{outline-color:{$colors['textcolor']};outline-color:{$colors['border_focus_color']};}
	input:focus,textarea:focus{border-color:{$colors['textcolor']};border-color:{$colors['border_focus_color']};}
	...
	.secondary-toggle{border-color:{$colors['sidebar_textcolor']};border-color:{$colors['sidebar_border_color']};}
	.secondary-toggle:hover,.secondary-toggle:focus{border-color:{$colors['sidebar_textcolor']};border-color:{$colors['sidebar_border_focus_color']};}
	...
	@media screen and (min-width: 38.75em){.page-header{border-color:{$colors['textcolor']};}}
	@media screen and (min-width: 59.6875em){
		...
		.secondary a,.dropdown-toggle:after,.widget-title,.widget blockquote cite,.widget blockquote small{color:{$colors['sidebar_textcolor']};}
