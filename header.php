	...
	<section id="sidebar" class="sidebar">
		<header id="masthead" class="site-header" role="banner">
			<div class="site-branding">
				...
				if(is_front_page()&&is_home()):echo'<h1 class="site-title"><a href="' . esc_url(home_url('/')) . '" rel="home">' . bloginfo('name') . '</a></h1>';else:echo'<a href="' . esc_url(home_url('/')) . '" class="site-title" rel="home">' . bloginfo('name') . '</a>';endif;
